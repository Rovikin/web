...
|---|---|---|---|---|---|---|---|
| **ADAUSDT** | 1 Day | 3001 | `15/40` | +9390.82% | -34.42% | -20.77% | ✅ Menang |
| **BCHUSDT** | 1 Day | 2411 | `25/75` | +200.06% | -55.10% | +8.60% | ✅ Menang |
| **BNBUSDT** | 1 Day | 3163 | `10/26` | +30822.68% | -31.91% | +36524.44% | ❌ Kalah |
| **BTCUSDT** | 1 Day | 3244 | `10/30` | +6804.41% | -52.55% | +1373.58% | ✅ Menang |
| **DOGEUSDT** | 1 Day | 2557 | `15/26` | +18176.70% | -56.62% | +1906.67% | ✅ Menang |
| **ETHUSDT** | 1 Day | 3244 | `10/20` | +7208.26% | -46.34% | +489.62% | ✅ Menang |
| **LINKUSDT** | 1 Day | 2727 | `5/100` | +1614.49% | -71.67% | +1535.55% | ✅ Menang |
| **PAXGUSDT** | 1 Day | 2137 | `20/150` | +130.22% | -8.78% | +110.72% | ✅ Menang |
| **SOLUSDT** | 1 Day | 2154 | `9/26` | +19514.56% | -44.22% | +2379.92% | ✅ Menang |
| **TRXUSDT** | 1 Day | 2946 | `12/30` | +1222.82% | -43.96% | +571.90% | ✅ Menang |
| **XLMUSDT** | 1 Day | 2957 | `5/30` | +426.96% | -61.98% | -30.09% | ✅ Menang |
| **XMRUSD** | 1 Day | 722 | `12/20` | +167.80% | -10.63% | +105.98% | ✅ Menang |
| **XRPUSDT** | 1 Day | 2984 | `9/200` | +99.26% | -50.56% | +30.06% | ✅ Menang |
| **ZECUSDT** | 1 Day | 2663 | `5/26` | +5629.58% | -75.56% | +740.46% | ✅ Menang |
...
| 5 | 20 | 68 | 29.4% | +109.52% | -66.39% | 1.65 |
...
- **Total candle:** 3244
- **Buy & Hold:** +489.62%
- **Rekomendasi (return tertinggi):** EMA `10/20` → Return +7208.26%, MaxDD -46.34%

**Top 10 berdasarkan Total Return**

| Fast | Slow | Trades | Win Rate | Return | Max DD | Calmar |
|---|---|---|---|---|---|---|
| 10 | 20 | 55 | 38.2% | +7208.26% | -46.34% | 155.55 |
| 20 | 26 | 36 | 38.9% | +6260.66% | -46.42% | 134.88 |
| 8 | 20 | 60 | 38.3% | +5915.67% | -45.00% | 131.47 |
| 9 | 20 | 60 | 36.7% | +5863.26% | -49.98% | 117.32 |
...
| 5 | 20 | 79 | 32.9% | +4784.27% | -49.33% | 96.99 |
...
- **Total candle:** 2154
- **Buy & Hold:** +2379.92%
- **Rekomendasi (return tertinggi):** EMA `9/26` → Return +19514.56%, MaxDD -44.22%

**Top 10 berdasarkan Total Return**

| Fast | Slow | Trades | Win Rate | Return | Max DD | Calmar |
|---|---|---|---|---|---|---|
| 9 | 26 | 37 | 35.1% | +19514.56% | -44.22% | 441.33 |
| 20 | 150 | 7 | 42.9% | +15636.48% | -25.67% | 609.02 |
| 8 | 26 | 42 | 33.3% | +15085.80% | -47.32% | 318.80 |
| 15 | 20 | 30 | 36.7% | +14554.53% | -42.23% | 344.63 |
| 12 | 20 | 39 | 35.9% | +14445.09% | -49.84% | 289.81 |
| 10 | 26 | 35 | 31.4% | +14372.37% | -44.00% | 326.68 |
| 8 | 30 | 35 | 31.4% | +12892.49% | -55.30% | 233.14 |
| 5 | 30 | 47 | 27.7% | +11838.29% | -57.19% | 206.98 |
| 10 | 20 | 43 | 32.6% | +11735.37% | -59.57% | 197.00 |
...
- **Total candle:** 2957
- **Buy & Hold:** -30.09%
- **Rekomendasi (return tertinggi):** EMA `5/30` → Return +426.96%, MaxDD -61.98%

**Top 10 berdasarkan Total Return**

| Fast | Slow | Trades | Win Rate | Return | Max DD | Calmar |
|---|---|---|---|---|---|---|
| 5 | 30 | 61 | 32.8% | +426.96% | -61.98% | 6.89 |
| 5 | 20 | 79 | 30.4% | +295.16% | -66.91% | 4.41 |
| 5 | 150 | 21 | 33.3% | +219.12% | -48.00% | 4.56 |
| 5 | 26 | 74 | 29.7% | +166.63% | -66.84% | 2.49 |
| 8 | 26 | 57 | 28.1% | +159.42% | -69.07% | 2.31 |
| 9 | 150 | 18 | 27.8% | +147.96% | -49.50% | 2.99 |
| 8 | 150 | 19 | 26.3% | +137.13% | -54.80% | 2.50 |
| 10 | 150 | 18 | 27.8% | +126.44% | -49.88% | 2.53 |
| 5 | 200 | 24 | 20.8% | +126.13% | -48.18% | 2.62 |
| 9 | 20 | 65 | 27.7% | +120.65% | -66.36% | 1.82 |
...
- **Total candle:** 2663
- **Buy & Hold:** +740.46%
- **Rekomendasi (return tertinggi):** EMA `5/26` → Return +5629.58%, MaxDD -75.56%

**Top 10 berdasarkan Total Return**

| Fast | Slow | Trades | Win Rate | Return | Max DD | Calmar |
|---|---|---|---|---|---|---|
| 5 | 26 | 58 | 32.8% | +5629.58% | -75.56% | 74.50 |
| 9 | 20 | 49 | 36.7% | +5611.51% | -51.62% | 108.71 |
| 8 | 20 | 51 | 35.3% | +5052.69% | -55.02% | 91.84 |
| 5 | 20 | 66 | 31.8% | +4226.82% | -72.86% | 58.01 |
